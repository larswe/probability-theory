...
text "A related theorem, the 'monotone class theorem', concerns the equality between the Dynkin
...
proof - 
  have "Mono \<Omega> M = M"
    by (simp add: algebra_least_sigma_mono assms sigma_algebra.sigma_sets_eq sigma_is_algebra) 
